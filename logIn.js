...
function hideAfterLogIn() {
  ...
  document.getElementById("packDetails").innerHTML =
    "Welcome " + uName + ", you now have access to the following:";
        ...
        if (uName == Global_C[i][0]) {
          if (nPwd == Global_C[i][1]) {
            if (Global_C[i][2] == 1) {
              ...
              document.getElementById("msgOnLogin").innerHTML =
            ...
            if (Global_C[i][2] == 2) {
              isValidPassword = true;
              alert(
                "The trial version has ended! Subscribe to access the modules!"
              );
            }
...
function showButtonsPaper2() {
  ...
  document.getElementsByClassName("Constitution_Card")[0].style.display =
    "none";
